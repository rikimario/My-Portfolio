      ...
      <div ref={aboutRef}>
        ...
        <div className="text-gray-300">
          <p>
            ...
            web development with React. I am very enthusiastic about new
            technologies and eager to learn more. User experience, prefect
          ...
          <p className="pt-4">
            ...
            the way. I'm building web applications using modern technologies
            such as React, Next.js, Tailwind and much more.
          </p>
          <p className="pt-4">
            I am very much a progressive thinker and enjoy working on products
            end to end, from idea all the way to development.
          </p>
        </div>
      </div>
    </div>
